...
\begin{figure}[hp]
	...
	\subfigure[Object Menu] {
		\label{fig:menu:object}
		\includegraphics[width=3in]{figs/object_menu.jpg}
	}
	\subfigure[Material Menu] {
		\label{fig:menu:material}
		\includegraphics[width=3in]{figs/material_menu.jpg}
	}
	\subfigure[Tools Menu] {
		\label{fig:menu:tools}
		\includegraphics[width=3in]{figs/tools_menu.jpg}
	}
	\subfigure[File Menu] {
		\label{fig:menu:file}
		\includegraphics[width=3in]{figs/file_menu.jpg}
	}
